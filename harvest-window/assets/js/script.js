...
async function setup() {
    const modelUrl = 'https://growappcannabis.guide/harvest-window/assets/js/model.json';
    const metadataUrl = 'https://growappcannabis.guide/harvest-window/assets/js/metadata.json';
